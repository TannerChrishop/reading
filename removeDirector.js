...
var App = {
  ...
  renderFooter: function () {
    ...
    if (todoCount > 0) {
      ...
      this.filtersUL = document.getElementById('filters');
      this.allFilter = this.filtersUL.children[0].children[0].addEventListener('click', this.applyFilter.bind(this, 'all'));
      this.activeFilter = this.filtersUL.children[1].children[0].addEventListener('click', this.applyFilter.bind(this, 'active'));
      this.completedFilter = this.filtersUL.children[2].children[0].addEventListener('click', this.applyFilter.bind(this, 'completed'));
    } else {
